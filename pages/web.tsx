...
const Web: NextPage = () => {
  ...
  const predict = async (img: HTMLImageElement) => {
    const modelUrl =
      "https://raw.githubusercontent.com/EricEchemane/Soil-Type-Classifier-Through-Image-Processing/main/src/tfjs/model.json";
    ...
    if (type === "not" || type === "alike" || confidence < 0.75) {
      setNotSoilType(type);
  ...
  return (
    <>
      ...
      <Paper shadow={"md"} px={"lg"} mb={"lg"}>
        <Container>
          <img
            src="https://raw.githubusercontent.com/devh2t/SoiLab_AI_Front/main/app/assets/logo.png?token=GHSAT0AAAAAAB3M2IJX5LPPZRT3ULL762YOY5I22BA"
            alt="logo"
            height={"70px"}
          />
          <sup>
      ...
      <Container>
        ...
        {notRecognized && (
          <Box p={"lg"}>
            <Title order={2} align="center" sx={{ color: "orange" }}>
              Ooops 🤔, il parait que vous navez pas choisi une image du sol.
            </Title>
            <Text align="center" size={"xl"} mt=".5rem">
              Supprimer les objest non necessaires de votre sol avant de prendre la capture ,
              sinon prendre une autre photo.
            </Text>
          </Box>
        )}
