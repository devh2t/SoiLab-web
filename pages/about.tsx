...
export default function about() {
    return (
        <>
            ...
            <Container py='lg'>
                <Stack spacing={'xl'}>
                    <Title> What Soilab is all about? </Title>
                    <Text>
                    ...
                    <Title order={4}> The Problems soilab aims to solve </Title>
                    <List withPadding>
                        <List.Item>
                    ...
                    <Text>
                        <i>SoiLab was made possible by the following stakeholders. They put significant amount of efforts in this project.</i>
                    </Text>
                    <List withPadding>
                        <List.Item> b3rday </List.Item>
