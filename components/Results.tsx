...
export default function Result(result: {
    ...
    if (!result) return (<Text weight={500}> Pas de résultat. Choisir dabord une image.</Text>);
    ...
    return (
        <>
            <Text weight={700} mb={10}> Résultats: </Text>
                            ...
                            if (prop[0] === "Suitable Plants") return <tr key={index}>
                                ...
                                <td>
                                    <Button
                                        ...
                                        variant="light">
                                        Voir la liste des cultures adaptées
                                    </Button>
                                </td>
                            </tr>;
                            return <tr key={index}>
            ...
            <Modal
                size="xl"
                title={<Title order={4} mb={10}> Cultures adaptées: </Title>}
                overflow="inside"
